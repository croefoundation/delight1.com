...
</head><body style="background-image:url(img/cn_029.jpg)">


           <div class="wrapper-page animated fadeInDown ">
               <div class="text-center" style=""><img src="img/D_logo_02.png" style="width:150px" class="m-y-1 "> </div>

               <div class="panel panel-color panel-info">
                   <div class="panel-heading ">
                       <h3 class="text-center m-t-10 ">Delight Family Sign In</h3>
                   </div>
                   <form class="form-horizontal m-t-40" name="login" action="./member/login_post.php" method="post">
                     ...
                     <!--<div class="form-group">
                       ...
                       <div class="form-group text-right" style="padding:0 10px;">
                           <div class="col-xs-12 ">

                                   <input class="btn btn-purple w-md" type="submit" value="log in">
                           </div>
                       </div>
